...
A REST API for Text-to-Speech synthesis using Kokoro TTS with automatic language detection and female voice selection.

## Features

- 🌍 **Automatic Language Detection**: Detects language from input text and selects appropriate TTS pipeline
- 👩 **Female Voices Only**: All default voices are female across all supported languages
- 🎵 **Multi-Language Support**: Supports 9 languages with high-quality synthesis
- ⚡ **Fast API**: Built with FastAPI for high performance
- 🔄 **Streaming Support**: Real-time audio streaming capabilities

## Supported Languages

- 🇺🇸 **English (American)** - Default voice: `af_bella`
- 🇬🇧 **English (British)** - Default voice: `bf_alice`
- 🇪🇸 **Spanish** - Default voice: `ef_dora`  
- 🇫🇷 **French** - Default voice: `ff_siwis`
- 🇮🇳 **Hindi** - Default voice: `hf_alpha`
- 🇮🇹 **Italian** - Default voice: `if_sara`
- 🇯🇵 **Japanese** - Default voice: `jf_alpha`
- 🇧🇷 **Portuguese** - Default voice: `pf_dora`
- 🇨🇳 **Chinese** - Default voice: `zf_xiaobei`

---

# Original Kokoro Documentation
